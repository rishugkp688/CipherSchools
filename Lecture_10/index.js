...
let person = {
  ...
  let person1 = new Person("Sanu", "Singh");
  let person2 = new Person("Aditya", "Raj");
  ...
  let personC1 = new PersonClass("Riya", 19);
  personC1.addAddress("Ayodhya");
  personC1.getDetails();
  ...
  let personWA1 = new PersonWithAccess("Ayush", "Chaturvedi");
  ...
  let student1 = new Student("Anshika", "Sharma", 22);
